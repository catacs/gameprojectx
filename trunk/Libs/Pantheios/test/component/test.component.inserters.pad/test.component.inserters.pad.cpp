...
PANTHEIOS_EXTERN_C const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "test.component.inserters.pad";
...
static void test_1_01()
{
    { for(size_t i = 0; i != 1000; ++i)
    {
        ...
        XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL(string_t(i, ' '), results[0].statement);
    }}
}
...
static void test_1_03()
{
    { for(size_t i = 0; i != 1/* 000 */; ++i)
    {
        ...
        else
        {
            ...
            XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL(string_t(i - 1u, ' '), results[0].statement);
        }
    }}
}
    ...
    { for(size_t i = 0; i != 1000; ++i)
    {
        ...
        { for(size_t j = 0; j != 1000; ++j)
        {
            ...
            if(i < j)
            {
                ...
                XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL(stmt, results[0].statement);
            }
            else
            {
                /* No padding */
                ...
                XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL(value, results[0].statement);
            }
        }}
    }}
}

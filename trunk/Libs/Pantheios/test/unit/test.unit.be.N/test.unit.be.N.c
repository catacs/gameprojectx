...
const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "test.unit.be.N";


#define DECLARE_BACK_END_IMPL_N(n)                                                      \
                                                                                        \
    PANTHEIOS_CALL(int) pantheios_be_N_test_ ## n ## _init( char const* processIdentity \
                                                ,   int         backEndId               \
                                                ,   void const* init                    \
                                                ,   void*       reserved                \
                                                ,   void**      ptoken);                \
    PANTHEIOS_CALL(void) pantheios_be_N_test_ ## n ## _uninit(void* token);             \
    PANTHEIOS_CALL(int) pantheios_be_N_test_ ## n ## _logEntry( void*       beToken     \
                                                            ,   void*       feToken     \
                                                            ,   int         severity    \
                                                            ,   char const* entry       \
                                                            ,   size_t      cchEntry);  \
...
/*
PANTHEIOS_CALL(void) pantheios_onBailOut(int severity, char const* message)
{
    STLSOFT_SUPPRESS_UNUSED(severity);

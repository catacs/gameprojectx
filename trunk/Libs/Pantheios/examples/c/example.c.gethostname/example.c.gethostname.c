/* /////////////////////////////////////////////////////////////////////////
 * File:        example/c/example.c.gethostname/example.c.gethostname.c
 *
 * Purpose:     Implementation file for the example.c.gethostname project.
 *
...
int main(int argc, char** argv)
{
    ...
    if(0 == cch)
    {
        ...
        if(0 == winstl__format_message_alloc_a(error, NULL, &message))
        {
        ...
        else
        {
            ...
            winstl__format_message_free_buff_a(message);
        }

# Microsoft Developer Studio Project File - Name="be.syslog" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Static Library" 0x0104

CFG=be.syslog - Win32 Release pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "be.syslog.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "be.syslog.mak" CFG="be.syslog - Win32 Release pseudoUNIX"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "be.syslog - Win32 Release pseudoUNIX" (based on "Win32 (x86) Static Library")
!MESSAGE "be.syslog - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Static Library")
!MESSAGE "be.syslog - Win32 Release Multithreaded pseudoUNIX" (based on "Win32 (x86) Static Library")
!MESSAGE "be.syslog - Win32 Debug Multithreaded pseudoUNIX" (based on "Win32 (x86) Static Library")
!MESSAGE "be.syslog - Win32 Release Multithreaded DLL pseudoUNIX" (based on "Win32 (x86) Static Library")
!MESSAGE "be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
!IF  "$(CFG)" == "be.syslog - Win32 Release pseudoUNIX"
...
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.lib"
# ADD LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.lib"

!ELSEIF  "$(CFG)" == "be.syslog - Win32 Debug pseudoUNIX"
...
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.debug.lib"
# ADD LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.debug.lib"

!ELSEIF  "$(CFG)" == "be.syslog - Win32 Release Multithreaded pseudoUNIX"
...
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.mt.lib"
# ADD LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.mt.lib"

!ELSEIF  "$(CFG)" == "be.syslog - Win32 Debug Multithreaded pseudoUNIX"
...
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.mt.debug.lib"
# ADD LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.mt.debug.lib"

!ELSEIF  "$(CFG)" == "be.syslog - Win32 Release Multithreaded DLL pseudoUNIX"
...
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.dll.lib"
# ADD LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.dll.lib"

!ELSEIF  "$(CFG)" == "be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX"
...
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.dll.debug.lib"
# ADD LIB32 /nologo /out:"../../../../lib/pantheios.1.be.syslog.vc6.unix.dll.debug.lib"

!ENDIF

# Begin Target

# Name "be.syslog - Win32 Release pseudoUNIX"
# Name "be.syslog - Win32 Debug pseudoUNIX"
# Name "be.syslog - Win32 Release Multithreaded pseudoUNIX"
# Name "be.syslog - Win32 Debug Multithreaded pseudoUNIX"
# Name "be.syslog - Win32 Release Multithreaded DLL pseudoUNIX"
# Name "be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX"
# Begin Group "Source Files"

# PROP Default_Filter "cpp;c;cxx;rc;def;r;odl;idl;hpj;bat"
# Begin Source File

SOURCE=..\..\..\..\src\backends\be.syslog.c
# End Source File
# End Group

/* /////////////////////////////////////////////////////////////////////////
 * File:        test/component/test.component.core.initialisation_sequence/test.component.core.initialisation_sequence.cpp
 *
...
PANTHEIOS_CALL(char const*) pantheios_fe_getProcessIdentity(void* token)
{
    ...
    return "test.component.core.initialisation_sequence";
}

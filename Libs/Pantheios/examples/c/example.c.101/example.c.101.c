...
const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "example.c.101";
...
int main()
{
    ...
    else
    {
        ...
        pantheios_logputs(PANTHEIOS_SEV_NOTICE, "pantheios_logputs() can output a single C-style string");
        ...
        pantheios_logprintf(PANTHEIOS_SEV_WARNING, "pantheios_logprintf() uses a format string like this one, and can output all the types compatible with the printf() family, including ints (e.g. i = %d), doubles (e.g. d = %G), and chars (e.g. c = %c)", i, d, c);
        ...
        pantheios_logprintf(PANTHEIOS_SEV_WARNING, "NOTE: pantheios_logprintf() output is limited to 4095 characters. The rest of this statement is a very long string of '-' characters, enclosed in quotations. As you can see, it will not be fully emitted: \"%s\"", bigBuff);

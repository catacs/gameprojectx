 ...
 * fe.N, fe.simple, etc. */
const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "example.c.extended_severity";
...
int main()
{
  ...
  if(i >= 0)
  {
    ...
    pantheios_logprintf(PANTHEIOS_MAKE_EXTENDED_SEVERITY(PANTHEIOS_SEV_NOTICE, 10), "hello");
...
#define ACME_XSEV(sev, xi28)    PANTHEIOS_MAKE_EXTENDED_SEVERITY(PANTHEIOS_SEV_ ## sev, xi28)
    ...
    pantheios_logprintf(ACME_XSEV(NOTICE, 10), "hello");
